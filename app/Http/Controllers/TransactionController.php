...
class TransactionController extends Controller
{
    ...
    public function storeTransaction(Request $request)
    {
        $validated = $request->validate([
            ...
            'status' => 'required|string|in:successful,declined', 
    ...
    public function updateTransaction(Request $request)
    {
        $validated = $request->validate([
            ...
            'status' => 'required|string|in:successful,declined',
            'total_amount' => 'required|numeric',
            'transaction_number' => 'required|string|unique:transactions,transaction_number,' . $request->id
        ]);
    ...
    public function deleteTransaction(Request $request)
    {
        ...
        return redirect()->route('getAllTransactions')->with('success', 'Transaction Deleted Successfully');
    }
}
